...
//wire          reset_core;
  ...
  //Wire for putting stuff on a bus
  wire [127:0]	dataBusW1;
  assign dataBusW1[127:16] = 124'd0;
  assign dataBusW1[15:0] = test_cnt1;
...
//assign reset_core = ~ pll_lock;// didn't fit
  ...
  //assign events_loc[15:0]   = test_cnt1[15:0];
  assign events_loc[15:0]   = 15'd0;
